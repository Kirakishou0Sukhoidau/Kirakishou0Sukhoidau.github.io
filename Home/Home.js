//bang thong bao
  ...
  var thongbao = document.getElementById("thongbao");
        ...
        dongy.onclick = function() {
            // Lưu trữ thông tin đồng ý của người dùng bằng cookie
        ...
        khongdongy.onclick = function() {
            // Thực hiện hành động khi người dùng chọn "Không đồng ý"
            // Ví dụ: thoát khỏi trang web
...
//cũ
/*const toggleButton = document.getElementById("toggle-tools"); 
const toolsContainer = document.getElementById("tools"); toggleButton.addEventListener("click", () => { 
    if (toolsContainer.style.display === "none") { toolsContainer.style.display = "block"; toggleButton.textContent = "✕"; } 
    else { toolsContainer.style.display = "none"; toggleButton.textContent = "☰"; } });
...
toggleButtons.forEach((button, index) => {
  button.addEventListener("click", () => {
    ...
    // Handle "✕" behavior regardless of ∆ state
    ...
    if (isMultiSelectionEnabled) {
      // Multi-selection enabled, toggle individual section
...
const ulBq = document.querySelector('.video');
